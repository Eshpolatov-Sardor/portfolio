...
<template>
  <div>
    <div class="flex flex-col md:flex-row justify-between items-center h-auto md:h-[82vh]">
      <div class="relative w-full md:w-1/3">
        <div class="absolute w-[300px] h-[350px] sm:w-[350px] sm:h-[400px] md:w-[390px] md:h-[440px] mt-8 ml-12 md:ml-0 bg-gradient-to-t from-black to-yellow-400 rounded-lg dark:bg-gradient-to-t dark:to-blue-600"></div>
        <NuxtImg
      ...
      <div class="w-full md:w-2/3 mt-8 md:mt-0 text-center md:text-left">
        <h1 class="text-2xl md:text-3xl text-blue-800 flex gap-4 items-center justify-center md:justify-start">
